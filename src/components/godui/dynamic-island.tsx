 ...
 *
 * Source as published by the `@godui/dynamic-island` registry entry. Kept in
 ...
 *
 * Local changes:
 *  1. `cn()` is imported from `@/lib/utils` and used for the shell class list
  ...
  (
    ...
    return (
      <motion.div
        ...
        className={cn(
          'relative flex items-center justify-center overflow-hidden bg-black text-white shadow-xl',
          className,
        )}
