 ...
 * GodUI — Accordion.
 *
 * Source as published by the `@godui/accordion` registry entry. Kept in
 ...
 *
 * Local changes:
 *  1. `cn()` is imported from `@/lib/utils` and used for the root class list
 ...
 * drop. The public API (`Accordion`, `AccordionItem`, `AccordionAnimation`,
 * `AccordionProps`) is unchanged.
 */
